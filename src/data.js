const data = [
  {
    ...
    heroImg: './images/hero-large-1.jpg',
...

  {
    ...
    img: './images/girl-with-earring.jpg',
    heroImg: './images/hero-large-5.jpg',
    ...
    year: 1665,
    artistImg: './images/artist-5.jpg',
    link: 'https://en.wikipedia.org/wiki/Girl_with_a_Pearl_Earring'
  },
  {
    id: 6,
    title: 'The Great Wawe off Kanagawa',
    author: 'Hokusai',
    img: './images/great-wave.jpg',
    heroImg: './images/hero-large-6.jpg',
    desc: `The Great Wave off Kanagawa (Japanese: 神奈川沖浪裏, Hepburn: Kanagawa-oki Nami Ura, lit. "Under the Wave off Kanagawa"), also known as The Great Wave or simply The Wave, is a woodblock print by the Japanese ukiyo-e artist Hokusai. It was published sometime between 1829 and 1833 in the late Edo period as the first print in Hokusai's series Thirty-six Views of Mount Fuji. The image depicts an enormous wave threatening three boats off the coast in the Sagami Bay (Kanagawa Prefecture) while Mount Fuji rises in the background.`,
    year: 1831,
    artistImg: './images/artist-6.jpg',
...

  {
    ...
    heroImg: './images/hero-large-9.jpg',
    desc: `The scene occurs within a room where, on the left, a wide-eyed bull stands over a grieving woman holding a dead child in her arms. In the center of the room a horse falls in agony with a large gaping hole in its side, as if it had just been run through by a spear or javelin. The horse appears to be wearing chain mail armor, decorated with vertical tally marks arranged in rows. A dead and dismembered soldier lies under the horse. The hand of his severed right arm grasps a shattered sword, from which a flower grows.`,
    year: 1937,
    artistImg: './images/artist-9.jpg',
  ...
  },
  {
    ...
    author: 'Vincent Van Gogh',
    img: './images/van-gogh-portrait.jpg',
    heroImg: './images/hero-large-10.jpg',
    desc: `This self-portrait was one of about 32 produced over a 10-year period, and these were an important part of his work as a painter; he painted himself because he often lacked the money to pay for models. He took the painting with him to Auvers-sur-Oise, near Paris, where he showed it to Dr. Paul Gachet, who thought it was "absolutely fanatical". Art historians are divided as to whether this painting or Self-portrait without beard is Van Gogh's final self-portrait. The art historians Ingo F. Walther and Jan Hulsker consider this to be the last.`,
    year: 1889,
    artistImg: './images/artist-1.jpg',
    link: 'https://en.wikipedia.org/wiki/Van_Gogh_self-portrait_(1889)'
  },
  {
    id: 11,
    title: 'Mona Lisa',
  ...
  },
  {
    ...
    author: 'Paul Cezanne',
    img: './images/basket-of-apples.jpg',
    heroImg: './images/hero-large-14.jpg',
    desc: `The Basket of Apples (French: Le panier de pommes) is a still life oil painting by French artist Paul Cézanne, which he created c. 1893. The painting is particularly remarkable for its creative composition, which rejected realistic representation in favour of distorting objects to create multiple perspectives. This approach eventually influenced other art movements, including Fauvism and Cubism. It belongs to the Helen Birch Bartlett Memorial Collection of the Art Institute of Chicago.`,
    year: 1893,
    artistImg: './images/artist-4.jpg',
    link: 'https://en.wikipedia.org/wiki/The_Basket_of_Apples'
  },
  {
    id: 15,
    title: 'The Swing',
    author: 'Jean-Honore Fragnonard',
    img: './images/the-swing.jpg',
    heroImg: './images/hero-large-15.jpg',
    desc: `The painting depicts an elegant young woman on a swing. A smiling young man, hiding in the bushes on the left, watches her from a vantage point that allows him to see up into her billowing dress, where his arm is pointed with hat in hand. A smiling older man, who is nearly hidden in the shadows on the right, propels the swing with a pair of ropes. The older man appears to be unaware of the young man. As the young lady swings high, she throws her left leg up, allowing her dainty shoe to fly through the air.`,
    year: 1767,
    artistImg: './images/artist-15.jpg',
